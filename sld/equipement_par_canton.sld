...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>nbre_eau_ogou</se:Name>
    <UserStyle>
      <se:Name>nbre_eau_ogou</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Bien équipé</se:Name>
          <se:Description>
            <se:Title>Bien équipé</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>reclass_ecart</ogc:PropertyName>
              <ogc:Literal>Bien équipé</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>Moyennement équipé</se:Name>
          <se:Description>
            <se:Title>Moyennement équipé</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>reclass_ecart</ogc:PropertyName>
              <ogc:Literal>Moyennement équipé</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#52fdf3</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>Sous-équipé</se:Name>
          <se:Description>
            <se:Title>Sous-équipé</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>reclass_ecart</ogc:PropertyName>
              <ogc:Literal>Sous-équipé</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#35b3eb</se:SvgParameter>
