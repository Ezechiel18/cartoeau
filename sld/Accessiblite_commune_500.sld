...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>eau_build_par_canton copie</se:Name>
    <UserStyle>
      <se:Name>eau_build_par_canton copie</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>faible accès</se:Name>
          <se:Description>
            <se:Title>faible accès</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Rclas_prop</ogc:PropertyName>
              <ogc:Literal>faible accès</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>accès moyen</se:Name>
          <se:Description>
            <se:Title>accès moyen</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Rclas_prop</ogc:PropertyName>
              <ogc:Literal>accès moyen</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>bon accès</se:Name>
          <se:Description>
            <se:Title>bon accès</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>Rclas_prop</ogc:PropertyName>
              <ogc:Literal>bon accès</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
